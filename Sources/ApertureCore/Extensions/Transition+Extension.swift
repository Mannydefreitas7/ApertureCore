...
extension Transition {
    ...
    public static func slideLeft(duration: Double = 0.5) -> Self {
        .init(type: .slideLeft, duration: duration)
    }

    public static func slideRight(duration: Double = 0.5) -> Self {
        .init(type: .slideRight, duration: duration)
    }

    public static func wipeRight(duration: Double = 0.5) -> Self {
        .init(type: .wipeRight, duration: duration)
    }

    public static func wipeLeft(duration: Double = 0.5) -> Self {
        .init(type: .wipeLeft, duration: duration)
    }

    public static func fade(duration: Double = 0.5) -> Self {
        .init(type: .fade, duration: duration)
    }

    public static func zoom(duration: Double = 0.5) -> Self {
        .init(type: .zoom, duration: duration)
    }

    public static func dissolve(duration: Double = 0.5) -> Self {
